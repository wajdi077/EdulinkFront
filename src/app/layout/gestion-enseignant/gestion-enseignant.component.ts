...
@Component({
    ...
    styleUrls: ['./gestion-enseignant.component.scss'],
    animations: [routerTransition()],
    providers: [EnseignantService, NgbModal],
})
export class GestionEnseignantComponent extends SelectionComponent implements OnInit {
    closeResult: string;
    t: string;
    bcheck :any ;
    list = [
...
nomutilisateur: Utilisateur = new Utilisateur() ; 
    ...
    constructor( private userService: EnseignantService,
    ...
    ngOnInit() {
        ...
        this.userService.getEnseignant()
